...
Revision ID: 837ea6114057
Revises: 25302b802fca
Create Date: 2020-10-09 21:36:15.135608
...
revision = '837ea6114057'
down_revision = '25302b802fca'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.alter_column('Artist', 'phone',
               existing_type=sa.VARCHAR(length=120),
               nullable=False)
    op.alter_column('Artist', 'seeking_describtion',
               existing_type=sa.VARCHAR(length=500),
               nullable=False)
    ...
    op.alter_column('Venue', 'phone',
               existing_type=sa.VARCHAR(length=120),
               nullable=False)
    op.alter_column('Venue', 'seeking_describtion',
               existing_type=sa.VARCHAR(length=500),
               nullable=False)
